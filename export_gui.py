...
STRINGS = {
    "en": {
        ...
        "mr_recent_toggle":        "📦 Recently Added",
        "mr_recent_toggle_tip_show": "Show the Recently Added Projects panel",
        "mr_recent_toggle_tip_hide": "Hide the panel to give the table more width",
        "mr_recent_hide":          "Hide »",
        ...
        "mr_col_src_strings": "en-US Strings",
    ...
    "zh": {
        ...
        "mr_recent_toggle":        "📦 新接入项目",
        "mr_recent_toggle_tip_show": "展开「最新支持的项目」面板",
        "mr_recent_toggle_tip_hide": "收起面板，把宽度留给表格",
        "mr_recent_hide":          "收起 »",
